      ...
      <section className="relative py-20 lg:py-28 overflow-hidden">
        ...
        <div className="relative z-10 container-custom text-center">
          ...
          <p className="section-subtitle mt-4">
            We craft dependable web apps for early‑stage companies and growing teams. Our trio — a
            Full‑Stack Developer, Project Manager, and Sales/Marketing lead — keeps delivery fast
            and focused. For world‑class UX/UI, we bring in trusted design partners per project.
          </p>
      ...
      <section className="py-16 lg:py-20 bg-black">
        <div className="container-custom">
          ...
          <p className="section-subtitle text-center">
            A product‑minded studio focused on shipping clear, maintainable software. We operate
            remote‑first and work closely with founders and product leads to turn goals into shipped
            features.
          </p>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="surface p-6">
              ...
              <p className="mt-2 text-dark-gray font-inter">
                Architecture, implementation, and DevOps‑lite. We build fast, reliable apps with
                React, Next.js, Node.js, TypeScript, and AWS.
              </p>
            </div>
            <div className="surface p-6">
              <h3 className="heading-3">Project Management</h3>
              <p className="mt-2 text-dark-gray font-inter">
                Clear scoping, weekly demos, and predictable delivery. We keep priorities and
                timelines visible so there are no surprises.
              </p>
            </div>
            <div className="surface p-6">
              <h3 className="heading-3">Sales & Marketing</h3>
              <p className="mt-2 text-dark-gray font-inter">
                Lead generation, proposals, and go‑to‑market support. We work with you to position
        ...
        <div className="container-custom">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="surface p-6">
              ...
              <p className="mt-2 text-dark-gray font-inter">
                Iterative delivery with weekly demos. Strong testing, accessibility, and performance
                from day one.
              </p>
            </div>
            <div className="surface p-6">
              ...
              <p className="mt-2 text-dark-gray font-inter">
                Maintenance, security, analytics, and small features on a predictable monthly
                retainer.
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                body: 'Straightforward solutions beat clever ones. We optimize for readability and long‑term maintainability.',
              },
              {
                title: 'Performance By Default',
                body: 'Fast pages convert better. We make speed a requirement, not a nice‑to‑have.',
              },
              {
                title: 'Accessibility Matters',
                body: 'Inclusive products are better products. We build with WCAG in mind from the start.',
              },
              {
                title: 'Transparent Communication',
                body: 'Weekly demos, honest trade‑offs, and tight feedback loops keep projects on track.',
              },
              {
                title: 'Security & Privacy',
                body: 'We follow sensible defaults, least privilege, and never ship secrets.',
              },
              {
                title: 'Ownership',
                body: 'We treat your product like our own — reliable, tested, and easy to evolve.',
              },
            ].map((p) => (
        ...
        <div className="container-custom">
          <div className="surface px-6 py-8 md:px-10 md:py-10 text-center">
            ...
            <p className="text-dark-gray font-inter max-w-3xl mx-auto mt-2">
              ...
              interfaces and a solid design system without carrying full‑time overhead. Want
              references?
      ...
      <section className="py-16 lg:py-24 bg-black">
        <div className="container-custom text-center">
          ...
          <p className="section-subtitle">
            Book a Discovery Sprint and get a clear, actionable plan.
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <Link href="/contact" className="btn-primary">
              Book a Sprint
