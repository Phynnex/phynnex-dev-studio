        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <p className="text-dark-gray mb-4 font-inter">
              When you choose our agency, you&apos;re not just getting a service provider –
            ...
            <p className="text-dark-gray mb-4 font-inter">
              ...
              industries, ensuring that your digital solutions are not only beautiful but also
              effective at achieving your business goals.
            </p>
            <p className="text-dark-gray mb-8 font-inter">
              We pride ourselves on clear communication, transparency throughout the process, and
              delivering projects on time and within budget.
            </p>
            <Link href="/services" className="inline-block btn-primary">
