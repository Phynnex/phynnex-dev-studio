  ...
  const faqItems = [
    {
      ...
      answer:
        'We provide a comprehensive range of digital services including web development, mobile app development, UI/UX design, custom software development, e-commerce solutions, and technical consulting. Our team specializes in creating tailored digital solutions that align with your business goals and user needs.',
    },
    {
      question: 'How do you handle project pricing?',
      answer:
        "Each project is unique, so we provide custom quotes based on the scope, complexity, and timeline of your specific needs. We offer transparent pricing with no hidden fees. After our initial consultation, we'll provide a detailed proposal outlining all costs and deliverables. We can work with both fixed-price projects and flexible engagement models.",
    },
    {
      question: 'What is your typical project timeline?',
      answer:
        "Project timelines vary depending on complexity and scope. A simple website might take 4-6 weeks, while a complex web application or mobile app could take 3-6 months. During our consultation, we'll discuss your timeline requirements and provide realistic estimates. We pride ourselves on clear communication and keeping projects on schedule.",
    },
    {
      question: 'Do you provide support after the project is launched?',
      answer:
        'Absolutely! We offer ongoing maintenance and support packages to ensure your digital solution continues to perform optimally. Our support includes bug fixes, security updates, performance optimization, and minor feature enhancements. We can tailor a support plan based on your specific needs and budget.',
    },
    {
      question: 'How do you ensure the quality of your work?',
      answer:
        "Quality is at the core of our process. We implement rigorous testing at every stage of development, including functional testing, usability testing, performance testing, and security audits. Our team follows industry best practices and coding standards. We also encourage client feedback throughout the project to ensure we're meeting expectations.",
    },
    {
      question: 'What technologies do you specialize in?',
      answer:
        'Our team is proficient in a wide range of modern technologies. For frontend development, we work with React, Next.js, and modern HTML/CSS frameworks like Tailwind CSS. On the backend, we specialize in Node.js, Express, MongoDB, PostgreSQL, and cloud services like AWS and Firebase. For mobile development, we primarily use React Native and Swift.',
    },
    {
      question: 'How do you handle project management and communication?',
      answer:
        "We believe in transparent and consistent communication. Each project is assigned a dedicated project manager who serves as your main point of contact. We use project management tools to track progress and share regular updates. Depending on your preference, we can schedule weekly check-ins via video call or email. We're also available for ad-hoc discussions as needed.",
    },
    {
