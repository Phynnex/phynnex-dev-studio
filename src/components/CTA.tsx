        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900/60 via-gray-800/40 to-black/60 backdrop-blur-xl border border-white/10 p-12 lg:p-16 animate-fade-in-up">
            ...
            <div className="relative z-10 text-center">
              {/* Icon */}
              <div
                className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-primary-purple/20 to-secondary-magenta/20 backdrop-blur-sm border border-white/10 mb-8 animate-fade-in-up"
              ...
              {/* Main heading */}
              <h2
                className="text-4xl md:text-5xl lg:text-6xl font-montserrat font-black tracking-tight text-white mb-6 animate-fade-in-up"
...
>>>>>>> 7f838a0a64a66680955e25ace51944497e54d392
              ...
              >
                ...
                <Link
                  href="/contact"
                  className="group relative overflow-hidden rounded-2xl bg-gradient-to-r from-primary-purple to-secondary-magenta p-0.5 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-primary-purple/25"
                >
                ...
                <Link
                  href="#portfolio"
                  className="group px-8 py-4 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/20 hover:border-primary-purple/50 hover:bg-white/10 transition-all duration-300"
                >
                  <div className="flex items-center space-x-3">
                    <Sparkles
                      size={20}
                      className="text-primary-purple group-hover:rotate-12 transition-transform duration-300"
                    />
                    <span className="font-montserrat font-semibold text-white">View Our Work</span>
                  </div>
                </Link>
              </div>
            </div>
          ...
          >
            {[
              ...
              <div
                key={index}
                className="group text-center p-6 rounded-2xl bg-gradient-to-br from-gray-900/30 via-gray-800/20 to-black/30 backdrop-blur-sm border border-white/5 hover:border-primary-purple/30 hover:bg-gradient-to-br hover:from-gray-800/40 hover:via-gray-700/30 hover:to-black/40 transition-all duration-500"
              >
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-primary-purple/10 border border-primary-purple/20 mb-4 group-hover:bg-primary-purple/20 group-hover:scale-110 transition-all duration-300">
                  <div className="text-primary-purple">{benefit.icon}</div>
                </div>
                ...
                <p className="text-gray-400 font-inter text-sm">{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
